...
for (const entry of dictionary) {
 ...
 var myElement=document.getElementsByClassName('videos'),
 dictionary = [
    ['images/VIDEO01.jpg', 'https://youtu.be/OW3CdpmD3w4'],
    ['images/VIDEO02.jpg', 'https://youtu.be/OW3CdpmD3w4'],
    ['images/VIDEO03.jpg', 'https://youtu.be/OW3CdpmD3w4'],
...
myRandomNum= Math.floor(Math.random() * dictionary.length);
function changeWord(myElement, dictionary){
    'use strict';
    setInterval(function () {
        myElement.src=dictionary [myRandomNum];
        
    }, 1000);
}

changeWord(myElement,dictionary);